...
namespace JoraClassLibrary.ProjectComponents
{
    internal sealed class Board
    {
        ...
        internal void CreateNewColumn(string name)
        {
            _columns.Add(new Column { Name = name });
        }

        internal bool LoadListColumnsWithTasks_FromFile(string name)// не нужно?
        {
        ...
        internal bool RemoveColumn(string name)
        {
            foreach (Column column in _columns)
            {
                if (name == column.Name)
        ...
        internal bool AddNewTask(string columnName, ProjectTask newTask)
        {
            foreach (Column column in _columns)
            {
        ...
        internal void ChangeTask(string taskName, string columnName, ProjectTask changedTask)
        {
        ...
        internal void MoveTask(string taskName, string oldColumn, string newColumn)
        {
